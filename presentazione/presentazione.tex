...
\titlegraphic{%
  \begin{picture}(0,0)
    \put(37,128){\makebox(0,0)[rt]{\includegraphics[width=2.30cm]{general/logo_unipv_cut.png}}}
  \end{picture}
}
 \date{30/04/2025}
...
\begin{frame}
    ...
    \vfill
    \centering
    \only<1>{\includegraphics[width=0.9\textwidth,keepaspectratio]{solar/all_by_period_1.png}}
    \only<2>{\includegraphics[width=0.9\textwidth,keepaspectratio]{solar/all_by_period_12.png}}
    \only<3>{\includegraphics[width=0.9\textwidth,keepaspectratio]{solar/all_by_period_123.png}}
    \only<4>{\includegraphics[width=0.9\textwidth,keepaspectratio]{solar/all_by_period_1234.png}}
...
\begin{frame}
    ...
    \vfill
    \centering
    \only<1>{\includegraphics[width=0.9\textwidth,keepaspectratio]{all_residenzial_load_period_1.png}}
    \only<2>{\includegraphics[width=0.9\textwidth,keepaspectratio]{all_residenzial_load_period_12.png}}
    \only<3>{\includegraphics[width=0.9\textwidth,keepaspectratio]{all_residenzial_load_period_123.png}}
    \only<4>{\includegraphics[width=0.9\textwidth,keepaspectratio]{all_residenzial_load_period_1234.png}}
...
\begin{frame}
    ...
    \vfill
    \centering
    \only<1>{\includegraphics[width=0.9\textwidth,keepaspectratio]{all_industrial_load_period_1.png}}
    \only<2>{\includegraphics[width=0.9\textwidth,keepaspectratio]{all_industrial_load_period_12.png}}
    \only<3>{\includegraphics[width=0.9\textwidth,keepaspectratio]{all_industrial_load_period_123.png}}
    \only<4>{\includegraphics[width=0.9\textwidth,keepaspectratio]{all_industrial_load_period_1234.png}}
...
\begin{frame}
    ...
    \begin{overlayarea}{\textwidth}{\textheight}
        \vfill
        \centering
        \only<1>{\includegraphics[width=0.55\textwidth]{general/spagna_blackout.jpg}}
    \end{overlayarea}
\end{frame}
