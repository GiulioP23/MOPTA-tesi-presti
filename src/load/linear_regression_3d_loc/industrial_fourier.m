% Industrial Load: linear regression (fourier) Biperiodic model by Location
...
data = df(df.Location_Electricity==loc, :);
...
[mse, nparams, sel] = tests_2d(data, phifun,sprintf( "Industrial Load - %s", loc.replace('_', '')), "Load (MWh)", write, pics);
