function [mse_vec, n_params_vec, select_vec] = tests_2d(data, phifun, data_desc, zlabel, verbose, pics)
    ...
    %% Lasso shrinkage
    % Feature selection
    [B,FitInfo] = lasso(full_phi, data_load, 'CV', 10); %"PredictorNames", ["c", "h", "p", "h2",  "p2", "hp", "h3", "p3", "h2p", "hp2", "h4", "h5", "h6", "h7", "h8"]
    ...
    % fit
    [thetaLS, theta_std] = lscov(phi_lasso, data_load);
   ...
   %% StepWise Forward regression
    ...
    mdl = stepwiselm(stepPhi, data_load, "constant", 'Upper', 'linear', "Criterion", "bic", "PRemove", Inf, "Verbose", 0);
    ...
    mdl = stepwiselm(stepPhi, data_load,'linear', "Criterion", "adjrsquared", "PEnter", Inf, "PRemove", 0, "Verbose", 0); % "Verbose", 0
